...
<head>
 ...
 <!-- <nav class="navbar navbar-expand-lg navbar-white bg-white">
  ...
  <div class="container">
    <div class="row">
        <div class="col-12">
            <h1 style="text-align: center;">Blog & Latest Updates</h1>
            <p style="text-align: center; font-size: 16px;">Read our blogs for some great wedding planning inspiration.</p>
 </div>
 </div> </div>
 <div class="container">
<div class="row">
    <div class="col-md-6">
<div>
    <img src="img/Wedding-themes-to-follow-as-per-different-seasons.jpg" alt="" style="width: 95%; border-radius: 5px;">
    <h1 style="font-size: 28px;text-align: center;">Wedding Themes To Follow As Per different Seasons</h1>
    <p style="text-align: center;">By adimin   March 6, 2023</p>
    <p style="text-align: center;">Indian weddings are a celebration of love,family,and culture.They<br>are known for their grandeur,vibancy,and axtravagance.A<br>wedding in India is india is not just an event;it is a fesitval....</p>
</div>
    </div>
<div class="col-md-6">
    <div>
        <img src="img/karwabanner.jpg" alt="" style="width: 95%;border-radius: 5px;">
    <h1 style="font-size: 28px;text-align: center;">5Must Haves for Karva Chauth Festival</h>
        <p style="text-align: center; font-size: 15px;">By adimin   March 6, 2023</p>
        <p style="text-align: center;font-size: 20px; ">#Karva chauthSpecial karva Chauth is around the corner & its the<br> most special day in everyone's life everyone's life. One of the most important day in amarried life for woman.for woman.for this beautiful...</p>
</div>
</div>
 ...
 <div class="col-md-6">
    <div>
   <img src="img/Decor-for-an-intimate-wedding-hd.jpg" alt="" style="width: 95%;border-radius: 5px;">
        <h1 style="font-size: 28px;text-align: center;">Wedding Themes To Follow As Per different Seasons</h1>
        <p style="text-align: center;">By adimin   March 6, 2023</p>
        <p style="text-align: center;">wedding are one of the most important event in a couple's life.It is a celebration of love and commitment .An intimate wedding is a beautiful of love and commitment.An intimate wedding is a<br> beautiful way to celebrate the union of two soul...</p>
    </div>
        </div>
        <div class="col-md-6">
            <div>
                <img src="img/feature-image-1.jpg" alt="" style="width: 95%; border-radius: 5px;">
                <h1 style="font-size: 28px;text-align: center;">The Tassel Story: The Quirky <br>setup For Your Mehendi</h1>   
                         <p style="text-align: center;">By adimin   March 6, 2023</p>
                         <p style="text-align: center;">Here are some brilliant uses of tassels we spotted at our wedding<br>decorations,and take a cue from them for yours too! Tassels have<br> been like the descry for wedding for wedding decor over the past...</p>
                 </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                   <div>
                  <img src="img/blog-cover.jpg" alt="" style="width: 95%;border-radius: 5px;">
                       <h1 style="font-size: 28px;text-align: center;">Wedding Themes To Follow As Per different Seasons</h1>
                       <p style="text-align: center;">By adimin   March 6, 2023</p>
                       <p style="text-align: center;">wedding are one of the most important event in a couple's life.It is a celebration of love and commitment .An intimate wedding is a beautiful of love and commitment.An intimate wedding is a<br> beautiful way to celebrate the union of two soul...</p>
                   </div>
                       ...
                       <div class="col-md-6">
                           <div>
                               <img src="img/7-vow-hindu-marriage-saat-phere-1.jpg" alt="" style="width: 95%; border-radius: 5px;">
                               <h1 style="font-size: 28px;text-align: center;">The Tassel Story: The Quirky <br>setup For Your Mehendi</h1>   
                                        <p style="text-align: center;">By adimin   March 6, 2023</p>
                                        <p style="text-align: center;">Here are some brilliant uses of tassels we spotted at our wedding<br>decorations,and take a cue from them for yours too! Tassels have<br> been like the descry for wedding for wedding decor over the past...</p>
                                </div>
                           ...
                           <div class="row">
                            <div class="col-md-6">
                               <div>
                              <img src="img/Wedding-Virality-is-the-New-Trend.jpeg" alt="" style="width: 95%;border-radius: 5px;">
                                   <h1 style="font-size: 28px;text-align: center;">Wedding Themes To Follow As Per different Seasons</h1>
                                   <p style="text-align: center;">By adimin   March 6, 2023</p>
                                   <p style="text-align: center;">wedding are one of the most important event in a couple's life.It is a celebration of love and commitment .An intimate wedding is a beautiful of love and commitment.An intimate wedding is a<br> beautiful way to celebrate the union of two soul...</p>
                               </div>
                                   ...
                                   <div class="col-md-6">
                                       <div>
                                           <img src="img/Destination-Wedding-in-Jaipur.jpg" alt="" style="width: 95%; border-radius: 5px;">
                                           <h1 style="font-size: 28px;text-align: center;">The Tassel Story: The Quirky <br>setup For Your Mehendi</h1>   
                                                    <p style="text-align: center;">By adimin   March 6, 2023</p>
                                                    <p style="text-align: center;">Here are some brilliant uses of tassels we spotted at our wedding<br>decorations,and take a cue from them for yours too! Tassels have<br> been like the descry for wedding for wedding decor over the past...</p>
                                            </div>
      ...
      <div class="">
        ...
        <div class="col-xl-4 col-md-6 col-12">
          ...
          <div class="">
            ...
            <div style="width: 98%; height: 100px; background-color: silver; margin-left: 12px; text-align: center;">
